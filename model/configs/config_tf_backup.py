...
class PipelineConfig:
    ...
    BEST_MODEL_PATH = os.path.join(BASE_DIR, "crop_disease_model.keras")
    ...
    OOD_CONFIDENCE_THRESHOLD = 0.00
    CONFIDENCE_REJECTION_THRESHOLD = 0.00 # Under 40% returns "Low Confidence"
